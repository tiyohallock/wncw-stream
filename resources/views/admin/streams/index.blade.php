    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <input class="form-control form-inline pull-right" name="search" placeholder="Search">
             ...
             <a class="btn btn-primary pull-right raw-margin-top-24" style="margin-top: 25px" href="{!! route('admin.streams.create') !!}">Add New</a>
            <h1>Stream Admin</h1>
        </div>
    </div>
    <div class="row">
            ...
            <table class="table table-striped raw-margin-top-24">
                ...
                <tbody>
                     @foreach($streams as $stream)
                            <tr>
                                <td><a href="{!! route('admin.streams.edit', [$stream->id]) !!}">{{ $stream->title }}</a></td>
                                <td>
                             ...
                             <form method="post" action="{!! url('admin/streams/'.$stream->id) !!}">
                                    ...
                                    <a class="btn btn-warning btn-xs pull-right raw-margin-right-16" href="{!! route('admin.streams.edit', [$stream->id]) !!}"><span class="fa fa-edit"></span> Edit</a>
